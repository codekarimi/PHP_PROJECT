                                ...
                                <div class="col-md-3 my-3 bg-warning mx-2" style="height: 150px;">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <a href="http://localhost:8080/Hospital%20management%20system/doctor/profile.php"> <i class="fas fa-procedures fa-3x fa-3x my-4" style="color: white;"></i></a>
                                ...
                                <div class="col-md-3 my-3 bg-success mx-2" style="height: 150px;">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <a href="http://localhost:8080/Hospital%20management%20system/doctor/profile.php"> <i class="fa fa-calender fa-3x my-4" style="color: white;"></i></a>
