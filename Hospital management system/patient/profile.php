                                 ...
                                 <div class="col-md-6">
                                     <?php
                                        ...
                                        if (isset($_POST['upload'])) {
                                            ...
                                            if (empty($img)) {
                                                ...
                                                $que = "UPDATE patient SET profile='$img' WHERE  username='$patient' ";
                                                ...
                                                if ($result) {
                                                    ...
                                                    move_uploaded_file($img,'C:/xampp/htdocs/Hospital management system/patient/img/'.$img);
                                                }
                                            }
                                        }
                                     ...
                                     <form action="" method="post" enctype="multipart/form-data">
                                         <?php
                                            ...
                                            echo '<img src="http://localhost:8080/Hospital%20management%20system/patient/img/'.$row["profile"].'" style="height:250px;" class="col-md-12 my-3">'
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <?php
                                        if (isset($_POST['change_pass'])) {
                                            ...
                                            $que = "SELECT * FROM patient WHERE username='$patient'";
